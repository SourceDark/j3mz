j3mzApp.factory('xinfaService', ['skillService', 'constService', function(skillService, constService) {
    var xinfas = [
        {
            type: constService.XinfaType.Taixujianyi,
            name: "太虚剑意",
            pinyin: 'taixujianyi',
            description: [
                '剑锋乍现虚难辨',
        ...
        {
            type: constService.XinfaType.Aoxuezhanyi,
            name: "傲雪战意",
            pinyin: 'aoxuezhanyi',
            description: [
                '枪划九天势破风',
    ...
    return {
        ...
        /*
        createXinfaWithType: function(xinfaType) {
            switch (xinfaType) {
                case XinfaType.Taixujianyi:
                    return {
                        useWeapon: true,
                        skills: [
                            skillService.getSkillByName("三环套月"),
